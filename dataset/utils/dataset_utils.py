...
def check(config_path, train_path, test_path, num_clients, niid=False, 
        balance=True, partition=None, dir_param=None):
...
def separate_data(data, num_clients, num_classes, niid=False, balance=False, partition=None, class_per_client=None, dir_param=None):
    ...
    if partition == 'pat':
        ...
        while min_size < least_samples:
            ...
            for k in range(K):
                ...
                proportions = np.random.dirichlet(np.repeat(float(dir_param), num_clients))
...
def save_file(config_path, train_path, test_path, train_data, test_data, num_clients, 
                num_classes, statistic, niid=False, balance=True, partition=None, dir_param=None):
    config = {
