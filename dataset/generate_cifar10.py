...
def generate_cifar10(dir_path, num_clients, niid, balance, partition, dir_param):
...
if __name__ == "__main__":
    ...
    dir_param: Optional[float] = sys.argv[4] if sys.argv[3] != "-" else None

    generate_cifar10(dir_path, num_clients, niid, balance, partition, dir_param)
