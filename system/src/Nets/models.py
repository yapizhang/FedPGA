...
class FedAvgMLP(nn.Module):
    def __init__(self, in_features=784, num_classes=10, hidden_dim=512):
        super().__init__()
...
class TestMLP(nn.Module):
    def __init__(self, in_features=784, num_classes=10, hidden_dim1=512, hidden_dim2=256):
        super().__init__()
        self.fc = nn.Linear(in_features, hidden_dim1)
...
class TestCNN(nn.Module):
    def __init__(self, in_features=1, num_classes=10, dim=384):
        super().__init__()
        self.conv1 = nn.Sequential(
            nn.Conv2d(in_features,
                        32,
...
class PolynomialRegression(nn.Module):
    def __init__(self, degree, input_dim=1*28*28, num_classes=10):
        super(PolynomialRegression, self).__init__()
        self.degree = degree
        self.polynomial_features = nn.Linear(input_dim, input_dim * degree)
        self.classifier = nn.Linear(input_dim * degree, num_classes)
